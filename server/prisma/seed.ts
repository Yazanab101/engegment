...
async function main() {
  ...
  const event = await prisma.event.upsert({
    ...
    create: {
      ...
      taglineAr: 'للأبد\nيبدأ من هنا',
      taglineHe: 'הנצח שלנו\nמתחיל כאן',
      joinUsMessageEn: 'We are delighted to invite you to celebrate our engagement — your presence completes our joy',
      joinUsMessageAr: 'يسعدنا أن تشاركونا فرحة خطوبتنا، فبحضوركم تكتمل فرحتنا',
      joinUsMessageHe: 'נשמח להזמינכם לחגוג את אירוסינו, בנוכחותכם שמחתנו שלמה',
      inviteLeadEn: 'We are delighted to invite you to celebrate our engagement — your presence completes our joy',
      inviteLeadAr: 'يسعدنا أن تشاركونا فرحة خطوبتنا، فبحضوركم تكتمل فرحتنا',
      inviteLeadHe: 'נשמח להזמינכם לחגוג את אירוסינו, בנוכחותכם שמחתנו שלמה',
