  ...
  asyncHandler(async (req, res) => {
    const body = z
      .object({
        ...
        titleHe: z.string().optional().nullable(),
        brideName: z.string().min(1).optional(),
        groomName: z.string().min(1).optional(),
        eventDate: z.string().datetime().optional(),
        eventStartTime: z.string().min(1).optional(),
        venueName: z.string().min(1).optional(),
        venueNameAr: z.string().optional().nullable(),
        venueNameHe: z.string().optional().nullable(),
        venueAddress: z.string().min(1).optional(),
        venueAddressAr: z.string().optional().nullable(),
        venueAddressHe: z.string().optional().nullable(),
        ...
        dressCodeAr: z.string().optional().nullable(),
        dressCodeHe: z.string().optional().nullable(),
        parkingInfo: z.string().optional().nullable(),
        parkingInfoAr: z.string().optional().nullable(),
        parkingInfoHe: z.string().optional().nullable(),
        additionalInfo: z.string().optional().nullable(),
        additionalInfoAr: z.string().optional().nullable(),
        additionalInfoHe: z.string().optional().nullable(),
        ...
        inviteLeadEn: z.string().optional().nullable(),
        inviteLeadAr: z.string().optional().nullable(),
        inviteLeadHe: z.string().optional().nullable(),
